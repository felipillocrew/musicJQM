...
*/
//echo $ThisFileInfo['tags']['id3v2']['artist'][0] .'<br>'; // artist from any/all available tag formats
//echo $ThisFileInfo['tags']['id3v2']['title'][0] .'<br>'; // artist from any/all available tag formats
//echo $ThisFileInfo['tags']['id3v2']['album'][0] .'<br>'; // artist from any/all available tag formats
//echo $ThisFileInfo['tags']['id3v2']['genre'][0] .'<br>'; // artist from any/all available tag formats
//echo $ThisFileInfo['tags']['id3v2']['year'][0] .'<br>'; // artist from any/all available tag formats
